defmodule Day1_Part1_V1 do
  ...
  defp get_digits(str) do
    ...
    if String.length(digits) == 1 do
      {String.at(digits, 0) |> String.to_integer(), String.at(digits, 0) |> String.to_integer()}
    else
      if String.length(digits) >= 2 do
        {String.at(digits, 0) |> String.to_integer(),
         String.at(digits, String.length(digits) - 1) |> String.to_integer()}
      else
        {0, 0}
      end
    end
  ...
  defp sum_values(str) do
    {first_digit, second_digit} = get_digits(str)
